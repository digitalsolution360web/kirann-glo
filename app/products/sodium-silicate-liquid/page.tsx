...
const salesSpec = [
  { particular: "1:2.00", sg: "1.56 – 1.66", baume: "51 – 55", na2o: "15.50 – 16.50%", sio2: "31.0 – 33.50%", weightRatio: "2.0 ±0.05" },
  { particular: "1:2.60", sg: "1.52 – 1.55", baume: "47 – 49", na2o: "11.50 – 12.50%", sio2: "31.0 – 33.50%", weightRatio: "2.60 ±0.5" },
  { particular: "1:3.20", sg: "1.38 – 1.41", baume: "39 – 41", na2o: "8.50 – 9.50%", sio2: "28.0 – 30.0%", weightRatio: "3.20 ±0.5" },
];
        ...
        <section className="bg-[#003d7a] relative overflow-hidden">
          ...
          <div className="max-w-[1700px] mx-auto px-6 sm:px-8 py-14 lg:py-18">
            <nav className="flex items-center gap-2 text-sm font-semibold text-blue-200 mb-6 flex-wrap">
              ...
              <ChevronRight size={14} className="text-blue-300/60" />
              <span className="text-[#f5c800] font-bold">Sodium Silicate Liquid</span>
            </nav>
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
              <div>

                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white tracking-tight leading-tight">
                  Sodium Silicate <span className="text-[#f5c800]">Liquid</span>
                </h1>
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              {activeSection === "overview" && (
                <div className="space-y-8">
                  <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
                    ...
                    <p className="text-black text-lg leading-relaxed font-semibold mb-4">
                      At Kiran Global Chem Ltd. we offer sodium silicate in liquid form for specific industrial
                      application where the liquid property of the chemical is highly effective. We manufacture
                      high quality silicates that are produced to match our customer&apos;s expectations. For special
                      requirements, we customize the liquid so that it can be integrated with highest efficacy
                      with the products of our clients.
                    </p>
                    <p className="text-black text-lg leading-relaxed font-semibold">
                      We manufacture liquid sodium silicates in different molar ratios, thus adjusting the
                      alkaline level in the silicates. Our research team advises customers on selecting the
                      most appropriate combination for their industrial application.
                    </p>
                    <div className="mt-8">
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="bg-[#003d7a] text-white">
                          {["Particular", "Specific Gravity", "Baume", "Na₂O", "SiO₂", "Weight Ratio"].map((h) => (
                      ...
                      <tbody>
                        {salesSpec.map((row, idx) => (
                          <tr key={idx} className={`border-t border-slate-200 ${idx % 2 === 0 ? "bg-white" : "bg-slate-50"} hover:bg-blue-50 transition-colors`}>
                            ...
                            <td className="px-5 py-4 text-base font-bold text-black">{row.na2o}</td>
              ...
              {activeSection === "applications" && (
                <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
                  ...
                  <p className="text-black font-semibold text-base mb-6">
                    Our clients use the sodium silicate liquid for manufacturing the following products:
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {activeSection === "packaging" && (
                <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
                  ...
                  <p className="text-black font-semibold text-base mb-6">
                    We offer the product for transportation in the following packages:
                  </p>
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className="bg-white rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                <div className="relative aspect-[4/3]">
                  <Image src="/sodium-silicate-liquidd.webp" alt="Sodium Silicate Liquid" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 33vw" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#003d7a]/70 to-transparent" />
                  <div className="absolute bottom-4 left-4">
                    <span className="inline-block bg-[#0072CE] text-white text-xs font-black uppercase tracking-wider px-4 py-2 rounded-full">Sodium Silicate Liquid</span>
                  </div>
                </div>
              </div>
