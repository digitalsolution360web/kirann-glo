...
const points = [
  "To seal leaks in the head gasket as sodium silicate acts as a powerful sealant at 93Â°C that will not re-melt below 815Â°",
...
const images = ["/ar1.jpg", "/ar2.jpg", "/ar3.jpg"];

export default function AutomotiveRepairPage() {
        ...
        {/* â”€â”€ HERO BANNER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          ...
          <div className="max-w-[1700px] mx-auto px-6 sm:px-8 py-12 lg:py-16 relative z-10">
            <nav className="flex items-center gap-2 text-sm font-semibold text-blue-200 mb-5 flex-wrap">
              ...
              <ChevronRight size={14} className="text-blue-300/60" />
              <span className="text-[#f5c800] font-bold">Automotive Repair</span>
            </nav>
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-sm space-y-6">
                <p className="text-black text-base sm:text-lg leading-relaxed font-bold">
                  Kiran Global Chem Ltd. supplies industrial chemicals to automotive industries for application for vehicles of all types and sizes. In automotive repair work, sodium and potassium silicate are largely used for their powerful properties. It is considered a â€œgreenâ€ solution for repair works as the products is largely derived from renewable sources, with minimum environment cost. Sodium and potassium silicate is largely used in automotive repair.
                </p>
