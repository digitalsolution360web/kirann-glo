...
const cosmeticsContent = [
  {
    title: "Sodium Silicate & Potassium Silicate",
    desc: "Skin Care and Hair Coloring formulas, Shaving Creams, Eye Make-up and Oral Hygiene products",
  },
  {
    title: "Precipitated silica",
    desc: "Toothpaste and tooth powder",
  },
];
        ...
        {/* â”€â”€ HERO BANNER (NO EXTRA CONTENT) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          ...
          <div className="max-w-[1700px] mx-auto px-6 sm:px-8 py-12 lg:py-16 relative z-10">
            <nav className="flex items-center gap-2 text-sm font-semibold text-blue-200 mb-5 flex-wrap">
              ...
              <ChevronRight size={14} className="text-blue-300/60" />
              <span className="text-[#f5c800] font-bold">Cosmetics</span>
            </nav>
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-sm">
                <p className="text-black text-lg leading-relaxed font-semibold">
                  Kiran Global Chem Ltd. supplies industrial chemicals for cosmetics manufacturing businesses. Our chemicals are blended with care to ensure that the cosmetics that are used sensitively do not cause any adverse damages or complications.
                </p>
              </div>

              {/* Products List */}
              <div className="space-y-4">
                {cosmeticsContent.map((item, idx) => (
                  <div
                    key={idx}
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="text-xl font-bold text-[#003d7a]">
                        {item.title}
                      </h3>
                    </div>
                    <p className="text-black text-base font-semibold pl-8">
                      {item.desc}
                    </p>
                  </div>
                ))}
