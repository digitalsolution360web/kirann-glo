...
export default function TimberTreatmentPage() {
        ...
        {/* â”€â”€ HERO BANNER (NO EXTRA CONTENT) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          ...
          <div className="max-w-[1700px] mx-auto px-6 sm:px-8 py-12 lg:py-16 relative z-10">
            <nav className="flex items-center gap-2 text-sm font-semibold text-blue-200 mb-5 flex-wrap">
              ...
              <ChevronRight size={14} className="text-blue-300/60" />
              <span className="text-[#f5c800] font-bold">Timber Treatment</span>
            </nav>
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-sm space-y-6">
                <p className="text-black text-lg leading-relaxed font-semibold">
                  Kiran Global Chem Ltd. supplies sodium silicate for timber treatment for clients in various industries. Our chemical solution is offered in liquid and lump form as per the grade of chemical intensity required and the packaging needs of our clients. Our customers generally use sodium silicate in timber treatment for:
                </p>
